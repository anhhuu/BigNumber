...
public:
    ...
    //
    //
    static std::string ConvertBitFromBoolToString(const bool * bits);
    
    //
    //
    //
    static bool * ConvertBitFromStringToBool(std::string bits);
    
    //
    //
    //
    static std::string ConvertDecToHex(std::string number);
